...
export default async function SignupIndexPage({
  ...
  if (type === 'user') redirect('/signup/user');
  if (type === 'authority') redirect('/signup/authority');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Button href="/signup/user" variant="primary" size="lg">
            Sign up as Citizen
          </Button>
          <Button href="/signup/authority" variant="outline" size="lg">
